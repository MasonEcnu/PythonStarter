...
from src.main.app.awesome_webapp.webapp.core_web import add_routes, add_static
...
async def response_factory(app, handler):
    async def response(request):
        ...
        if isinstance(r, dict):
            ...
            if template is None:
                body_json_str = json.dumps(r, ensure_ascii=False, default=lambda o: o.__dict__)
                resp = web.Response(body=body_json_str.encode("utf-8"))
